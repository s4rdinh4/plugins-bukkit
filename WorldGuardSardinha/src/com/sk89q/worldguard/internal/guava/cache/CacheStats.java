...
/* 222 */         Math.max(0L, this.hitCount - other.hitCount), 
/* 223 */         Math.max(0L, this.missCount - other.missCount), 
/* 224 */         Math.max(0L, this.loadSuccessCount - other.loadSuccessCount), 
/* 225 */         Math.max(0L, this.loadExceptionCount - other.loadExceptionCount), 
/* 226 */         Math.max(0L, this.totalLoadTime - other.totalLoadTime), 
/* 227 */         Math.max(0L, this.evictionCount - other.evictionCount));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public int hashCode() {
/* 248 */     return Objects.hashCode(new Object[] { Long.valueOf(this.hitCount), Long.valueOf(this.missCount), Long.valueOf(this.loadSuccessCount), Long.valueOf(this.loadExceptionCount), 
/* 249 */           Long.valueOf(this.totalLoadTime), Long.valueOf(this.evictionCount) });
/*     */   }
/*     */ 
/*     */   
...
/* 275 */     return MoreObjects.toStringHelper(this).add("hitCount", this.hitCount).add("missCount", this.missCount).add("loadSuccessCount", this.loadSuccessCount).add("loadExceptionCount", this.loadExceptionCount).add("totalLoadTime", this.totalLoadTime).add("evictionCount", this.evictionCount).toString();
/*     */   }
/*     */ }


/* Location:              C:\Users\igors\Desktop\worldguard-6.0.0-beta-05.jar!\com\sk89q\worldguard\internal\guava\cache\CacheStats.class
