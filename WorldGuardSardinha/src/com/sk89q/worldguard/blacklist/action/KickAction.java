...
/*    */       
/* 45 */       if (message != null) {
/* 46 */         event.getPlayer().kick(String.format(message, new Object[] { event.getTarget().getFriendlyName() }));
/*    */       } else {
...
/* Location:              C:\Users\igors\Desktop\worldguard-6.0.0-beta-05.jar!\com\sk89q\worldguard\blacklist\action\KickAction.class
