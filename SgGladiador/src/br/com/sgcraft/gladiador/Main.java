...
public class Main extends JavaPlugin
{
    ...
    public void onEnable() {
        ...
        this.getServer().getPluginCommand("gladiador").setExecutor((CommandExecutor)new Comando(this));
        this.getServer().getPluginCommand("gladiadores").setExecutor((CommandExecutor)new Comando(this));
        this.getServer().getPluginCommand("castelo").setExecutor((CommandExecutor)new Utils(this));
    ...
    public void onDisable() {
        this.getLogger().info("Desativando SgCraft - Gladiador");
    }
            ...
            for (final String n : Mensagens.getFinalizar()) {
                if ((this.mito || !n.startsWith("(mito)")) && (!this.mito || !n.startsWith("(gladiador)"))) {
                    if (n.startsWith("(gladiador)")) {
                        this.getServer().broadcastMessage(n.replace("&", "§").substring(11).replace("@clan", vencedor.getName()).replace("@dinheiro", Double.toString(this.getConfig().getDouble("Premios.Dinheiro"))).replace("@vencedores", String.valueOf(String.valueOf(v1)) + " (" + v1_v + ")" + ((v2 != null) ? (" e " + v2 + " (" + v2_v + ")") : "")));
                    }
                    else if (n.startsWith("(mito)")) {
                        this.getServer().broadcastMessage(n.replace("&", "§").substring(6).replace("@clan", vencedor.getName()).replace("@dinheiro", Double.toString(this.getConfig().getDouble("Premios.Dinheiro"))).replace("@mito", String.valueOf(String.valueOf(v1)) + " (" + v1_v + ")").replace("@vencedores", String.valueOf(String.valueOf(v2)) + " (" + v2_v + ")" + ((v3 != null) ? (" e " + v3 + " (" + v3_v + ")") : "")));
                    }
                    else if (!this.mito) {
                        this.getServer().broadcastMessage(n.replace("&", "§").replace("@clan", vencedor.getName()).replace("@dinheiro", Double.toString(this.getConfig().getDouble("Premios.Dinheiro"))).replace("@vencedores", String.valueOf(String.valueOf(v1)) + " (" + v1_v + ")" + ((v2 != null) ? (" e " + v2 + " (" + v2_v + ")") : "")));
                    }
                    else {
                        this.getServer().broadcastMessage(n.replace("&", "§").replace("@clan", vencedor.getName()).replace("@dinheiro", Double.toString(this.getConfig().getDouble("Premios.Dinheiro"))).replace("@mito", String.valueOf(String.valueOf(v1)) + " (" + v1_v + ")").replace("@vencedores", String.valueOf(String.valueOf(v2)) + " (" + v2_v + ")" + ((v3 != null) ? (" e " + v3 + " (" + v3_v + ")") : "")));
                    }
                }
            }
