...
public class Comando implements CommandExecutor
{
        ...
        if (args.length == 0) {
            ...
            if (args.length == 1 && args[0].equalsIgnoreCase("apostar")) {
                if (this.plugin.getGladiadorEtapa() != 3) {
                    sender.sendMessage("§7[§6Gladiador§7]  §cO gladiador n\u00e3o esta ocorrendo!");
                    return true;
                }
                ...
                if (args[0].equalsIgnoreCase("camarote")) {
                    ...
                    if (args[0].equalsIgnoreCase("iniciar")) {
                        ...
                        sender.sendMessage("§7[§6Gladiador§7] §aEvento gladiador sendo iniciado em uma arena Aleatória!");
                        ...
                        if (sender.hasPermission("gladiador.reset")) {
                            ...
                            sender.sendMessage("\"§7[§6Gladiador§7] §cOs TOPs ganhadores foram resetados!");
                            return true;
                        }
                        sender.sendMessage(Mensagens.getMensagem("Erro10"));
                        return true;
                        ...
                        if (this.plugin.getGladiadorEtapa() == 0) {
                            sender.sendMessage("§7[§6Gladiador§7] §cN\u00e3o existe nenhum evento gladiador sendo executado!");
                            return true;
                        }
                        this.plugin.cancelGladiador();
                        sender.sendMessage("§7[§6Gladiador§7] §aEvento gladiador sendo parado!");
                        return true;
                    }
                    else if (args[0].equalsIgnoreCase("kick")) {
                        if (args.length < 2) {
                            sender.sendMessage("§7[§6Gladiador§7] §c/gladiador kick <nome>");
                            return true;
                        }
                        ...
                        sender.sendMessage("§7[§6Gladiador§7] §f" + nome + " §cfoi kickado do evento gladiador!");
                        return true;
                    }
                    else if (args[0].equalsIgnoreCase("info")) {
                        if (this.plugin.getGladiadorEtapa() != 3) {
                            sender.sendMessage("§7[§6Gladiador§7] §cO evento gladiador n\u00e3o comecou!");
                            return true;
                        }
                        ...
                        sender.sendMessage("§7[§6Gladiador§7] §eRestam os clans: " + sb.toString());
                        ...
                        sender.sendMessage("§7[§6Gladiador§7] §eRestam os jogadores: §f " + sab.toString());
                        return true;
                    }
                        ...
                        sender.sendMessage("§7[§6Gladiador§7] §f" + nome + " §cfoi banido dos eventos gladiadores!");
                        return true;
                    }
                        ...
                        if (!this.plugin.getConfig().contains("Bans." + nome)) {
                            sender.sendMessage("§7[§6Gladiador§7] §cJogador n\u00e3o esta banido!");
                            return true;
                        }
                        this.plugin.getConfig().set("Bans." + nome, (Object)null);
                        this.plugin.saveConfig();
                        sender.sendMessage("§7[§6Gladiador§7] §f" + nome + " §efoi desbanido dos eventos gladiadores!");
                        return true;
                    }
    ...
    private void sendHelp(final Player p) {
        ...
        p.sendMessage(ChatColor.AQUA + "/gladiador iniciar " + ChatColor.WHITE + "- Inicia o evento gladiador");
        p.sendMessage(ChatColor.AQUA + "/gladiador parar " + ChatColor.WHITE + "- Para o evento gladiador");
        ...
        p.sendMessage(ChatColor.RED + "/castelo recarregar " + ChatColor.WHITE + "- Reseta os baus");
