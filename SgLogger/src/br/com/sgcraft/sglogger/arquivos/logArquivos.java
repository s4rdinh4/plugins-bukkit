package br.com.sgcraft.sglogger.arquivos;
...
public class logArquivos
{
    ...
    static {
        logArquivos.dateformat = getConfig.LogDateFormat();
        DATE_FORMAT_NOW = logArquivos.dateformat;
    }
    
    public logArquivos(final Main instance) {
    ...
    public static void logBucket(String playername, final String worldname, final int x, final int y, final int z, final Boolean lava, final Boolean staff) {
        ...
        try {
            ...
            final PrintWriter out = new PrintWriter(outfile);
            user.createNewFile();
            out.println("[" + getTimestamp() + "] " + playername + " Usou um balde de " + water + " / Mundo: " + worldname + " X: " + (int)x + " Y: " + (int)y + " Z: " + (int)z);
            out.close();
        }
        catch (IOException e) {
            e.printStackTrace();
    ...
    public static void logSign(String playername, final String worldname, final int x, final int y, final int z, final String[] lines, final Boolean staff) {
        ...
        try {
            ...
            final PrintWriter out = new PrintWriter(outfile);
            user.createNewFile();
            out.println("[" + getTimestamp() + "] " + playername + " Placa: " + lines[0] + " " + lines[1] + " " + lines[2] + " " + lines[3] + " / Local: " + worldname + " X: " + (int)x + " Y: " + (int)y + " Z: " + (int)z);
            out.close();
        }
        catch (IOException e) {
            e.printStackTrace();
    ...
    public static void logPlace(String playername, final String worldname, final String blockname, final int x, final int y, final int z, final Boolean staff) {
        ...
        try {
            ...
            final PrintWriter out = new PrintWriter(outfile);
            user.createNewFile();
            out.println("[" + getTimestamp() + "] " + playername + " Colocou o Bloco: " + blockname + " / Local: " + worldname + " X: " + (int)x + " Y: " + (int)y + " Z: " + (int)z);
            out.close();
        }
        catch (IOException e) {
            e.printStackTrace();
    ...
    public static void logBreak(String playername, final String worldname, final String blockname, final int x, final int y, final int z, final Boolean staff) {
        ...
        try {
            ...
            final PrintWriter out = new PrintWriter(outfile);
            user.createNewFile();
            out.println("[" + getTimestamp() + "] " + playername + " Quebrou o Bloco: " + blockname + " / Local: " + worldname + " X: " + (int)x + " Y: " + (int)y + " Z: " + (int)z);
            out.close();
        }
        catch (IOException e) {
            e.printStackTrace();
    ...
    public static void logDrop(String playername, final String worldname, final String ItemName, final int x, final int y, final int z, final Boolean staff) {
        ...
        try {
            ...
            final PrintWriter out = new PrintWriter(outfile);
            user.createNewFile();
            out.println("[" + getTimestamp() + "] " + playername + " Dropou o Item: " + ItemName + " / Local: " + worldname + " X: " + (int)x + " Y: " + (int)y + " Z: " + (int)z);
            out.close();
        }
        catch (IOException e) {
            e.printStackTrace();
    ...
    public static void logPickup(String playername, final String worldname, final String ItemName, final int x, final int y, final int z, final Boolean staff) {
        ...
        try {
            ...
            final PrintWriter out = new PrintWriter(outfile);
            user.createNewFile();
            out.println("[" + getTimestamp() + "] " + playername + " Pegou o Item: " + ItemName + " / Local: " + worldname + " X:" + (int)x + " Y: " + (int)y + " Z: " + (int)z);
            out.close();
        }
        catch (IOException e) {
            e.printStackTrace();
    ...
    private static String getTimestamp() {
        ...
        final SimpleDateFormat sdf = new SimpleDateFormat(logArquivos.DATE_FORMAT_NOW);
